...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%76F'  # yellow foreground
      # local   modified='%178F'  # yellow foreground
      local  untracked='%178F'   # blue foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=094
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=196
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=196
